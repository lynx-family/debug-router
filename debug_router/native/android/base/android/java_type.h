...
#ifndef DEBUGROUTER_NATIVE_ANDROID_BASE_ANDROID_JAVA_TYPE_H_
#define DEBUGROUTER_NATIVE_ANDROID_BASE_ANDROID_JAVA_TYPE_H_
...
#endif  // DEBUGROUTER_NATIVE_ANDROID_BASE_ANDROID_JAVA_TYPE_H_
