...
class DebugRouterHarmony {
 ...
 private:
  ...
  static std::map<napi_value, std::shared_ptr<DebugRouterGlobalHandlerHarmony>, NapiValueCompare> global_handlers;
  static std::map<napi_value, std::shared_ptr<DebugRouterSessionHandlerHarmony>, NapiValueCompare> session_handlers;
  static std::map<napi_value, std::shared_ptr<DebugRouterMessageHandlerHarmony>, NapiValueCompare> message_handlers;
};
