...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
...
namespace fml {
using debugrouter::fml::AutoResetWaitableEvent;
using debugrouter::fml::ManualResetWaitableEvent;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_SYNCHRONIZATION_WAITABLE_EVENT_H_
