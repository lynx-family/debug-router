...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MEMORY_REF_COUNTED_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MEMORY_REF_COUNTED_H_

#include <type_traits>

#include "debug_router/native/harmony/base/fml/memory/ref_counted_internal.h"
...
#define FML_FRIEND_REF_COUNTED_THREAD_SAFE(T) \
  friend class debugrouter::fml::RefCountedThreadSafe<T>
...
#define FML_FRIEND_MAKE_REF_COUNTED(T) \
  friend class debugrouter::fml::internal::MakeRefCountedHelper<T>
...
namespace fml {
using debugrouter::fml::RefCountedThreadSafe;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MEMORY_REF_COUNTED_H_
