...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MESSAGE_LOOP_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MESSAGE_LOOP_H_
#include <iostream>

#include "debug_router/native/harmony/base/fml/macros.h"
#include "debug_router/native/harmony/base/fml/task_queue_id.h"
#include "debug_router/native/harmony/base/fml/task_runner.h"
...
namespace fml {
using debugrouter::fml::MessageLoop;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MESSAGE_LOOP_H_
