...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_OBJECT_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_OBJECT_H_

#include <utility>

#include "debug_router/native/harmony/base/compiler_specific.h"
...
class UniqueObject {
 ...
 public:
  ...
  void reset(const T& value = Traits::InvalidValue()) {
    DEBUGROUTER_BASE_CHECK(data_.value_ == Traits::InvalidValue() ||
                           data_.value_ != value);
    FreeIfNecessary();
    data_.value_ = value;
  }
...
namespace fml {
using debugrouter::fml::UniqueObject;
}

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_OBJECT_H_
