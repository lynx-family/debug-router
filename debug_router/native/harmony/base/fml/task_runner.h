...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_RUNNER_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_RUNNER_H_
...
namespace fml {
using debugrouter::fml::BasicTaskRunner;
using debugrouter::fml::TaskRunner;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_RUNNER_H_
