...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_QUEUE_ID_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_QUEUE_ID_H_
...
namespace fml {
using debugrouter::fml::TaskQueueId;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TASK_QUEUE_ID_H_
