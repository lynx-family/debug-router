...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MESSAGE_LOOP_IMPL_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MESSAGE_LOOP_IMPL_H_
...
#include "debug_router/native/harmony/base/fml/time/time_delta.h"
...
namespace fml {
using debugrouter::fml::MessageLoopImpl;
}  // namespace fml
