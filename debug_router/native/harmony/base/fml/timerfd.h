...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TIMERFD_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TIMERFD_H_
...
namespace fml {
using debugrouter::fml::TimerDrain;
using debugrouter::fml::TimerRearm;
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_TIMERFD_H_
