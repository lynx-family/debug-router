...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_FD_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_FD_H_

#include "build/build_config.h"
#include "debug_router/native/harmony/base/fml/unique_object.h"
...
namespace fml {
using debugrouter::fml::UniqueFD;
#if !OS_WIN
using debugrouter::fml::UniqueDir;
#endif
}  // namespace fml

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_UNIQUE_FD_H_
