...
#include "debug_router/native/harmony/base/fml/message_loop_harmony.h"

#include <fcntl.h>
#include <uv.h>

#include "debug_router/native/harmony/base/fml/timerfd.h"
...
MessageLoopHarmony::MessageLoopHarmony(void* platform_loop)
  ...
  DEBUGROUTER_BASE_CHECK(timer_fd_.is_valid());
