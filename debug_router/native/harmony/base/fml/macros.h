...
#ifndef DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MACROS_H_
#define DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MACROS_H_
...
// TODO(zhengsenyao): Support stream operator << for DEBUGROUTER_(D)BASE_CHECK
#define DEBUGROUTER_BASE_CHECK(condition) (condition) ? (void)0 : abort();

#ifndef NDEBUG
#define DEBUGROUTER_BASE_DCHECK(condition) DEBUGROUTER_BASE_CHECK(condition)
#else
#define DEBUGROUTER_BASE_DCHECK(condition) (void)0
#endif

#endif  // DEBUGROUTER_HARMONY_DEBUGROUTER_SRC_MAIN_BASE_FML_MACROS_H_
